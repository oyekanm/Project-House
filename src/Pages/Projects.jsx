...
function Projects() {
  const { data: projects, loading, error } = GetProject();
  const data = projects?.getAllProject;
  ...
  console.log(loading, error, project);
      ...
      {project.length ? (
        <>
          ...
          <div className="categories">
            {/* categories button for filtering projects */}
          ...
          <div className="Projects">
            ...
            {project &&
              project.map((project) => {
                const { _id, author, image, name, language, url, github } =
                  project;
                return (
                  <div
                    key={_id}
